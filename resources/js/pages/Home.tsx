...
export default function Home() {
    return (
        <MainLayout title="Dei Gratia School Inc. | Home" className="bg-gradient-to-b from-white via-slate-50 to-white">
            <section className="relative isolate flex min-h-[60vh] items-center overflow-hidden rounded-b-[2.5rem] bg-slate-900">
                <img
                ...
                <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center gap-6 px-6 py-20 text-center text-white">
                    <p className="text-xs tracking-[0.4em] text-slate-200 uppercase">Dei Gratia School Inc.</p>
                    <h1 className="text-3xl leading-tight font-semibold sm:text-5xl">Nurturing Minds, Building Futures</h1>
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row">
                        ...
                        <Button variant="outline" asChild className="border-white/70 bg-transparent text-white hover:bg-white/10">
            ...
            <section className="mx-auto mt-20 w-full max-w-6xl px-4 pb-20">
                ...
                <div className="mt-10 grid gap-6 md:grid-cols-3">
                    {differentiators.map((item) => (
                        <div key={item.title} className="rounded-3xl border border-slate-200/70 bg-white/90 p-8 text-center shadow-sm">
